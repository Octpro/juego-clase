...
var animatedSprite = player_instantiate.get_node("Player/AnimatedSprite2D")
...
func add_player(id):
	...
	send_message.rpc(str(id), " entro al juego", false)
...
func remove_player(id):
	...
	send_message.rpc(str(id), " salio del juego", false)
...
# Define la función "play_animation" en el script del cliente
func play_animation():
	var animatedSprite = player_instantiate.get_node("Player/AnimatedSprite2D")
	animatedSprite.play()
